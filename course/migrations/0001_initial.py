# -*- coding: utf-8 -*-
# Generated by Django 1.11.15 on 2018-11-09 09:10
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('level', models.SmallIntegerField(choices=[(0, '初级'), (1, '中级'), (3, '高级')], default=1)),
                ...
                ('order', models.IntegerField(help_text='从上一个数据往后排', verbose_name='课程顺序')),
                ('study_num', models.IntegerField(help_text='只要有人购买, 订单表加入数据的同时给这个字段+1', verbose_name='学习人数')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('hourse', models.IntegerField(default=7, verbose_name='课时')),
                ...
                ('vido_brief_link', models.CharField(blank=True, max_length=255, null=True)),
                ('prerequisite', models.TextField(max_length=1204, verbose_name='课程先修要求')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('course_detail', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_outline', to='course.CourseDetail', verbose_name='课程详细')),
            ],
            options={
                'verbose_name': '12-课程大纲',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('section_order', models.SmallIntegerField(help_text='建议每个课时之间空1至两个值, 以备后续插入课时', verbose_name='课时安排')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(max_length=32, verbose_name='学位课程')),
            ],
            options={
                'verbose_name': '05-学位课程',
                'verbose_name_plural': '05-学位课程',
                'db_table': '05-学位课程',
            },
        ),
        migrations.CreateModel(
            ...
            options={
                'verbose_name': '09-常见问题',
                'verbose_name_plural': '09-常见问题',
                'db_table': '09-常见问题',
            },
        ),
        migrations.CreateModel(
